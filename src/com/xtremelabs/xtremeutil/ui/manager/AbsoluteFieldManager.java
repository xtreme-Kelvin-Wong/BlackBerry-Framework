...
public class AbsoluteFieldManager extends Manager {
    ...
    // from Field.java; these are @category Open post 4.6
    static final int AXIS_SEQUENTIAL = 0;
    static final int AXIS_HORIZONTAL = 1 << 0;
    static final int AXIS_VERTICAL   = 1 << 1;
